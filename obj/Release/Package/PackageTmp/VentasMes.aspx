<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VentasMes.aspx.cs" Inherits="PanelAdmin.VentasMes" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">   
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="VENTAS MES"  CssClass="titulocard"></asp:Label>                                                
                    </div>                   
                </div>
            </div>
        <div class="card-body">
                <div class="form-row">    
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" GridLines="None" AllowPaging="True" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="20" ForeColor="Black" margin-left="2%" DataKeyNames="Row">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TipoVenta" HeaderText="TipoVenta" SortExpression="TipoVenta"></asp:BoundField>
                            <asp:BoundField DataField="Metodo" HeaderText="Metodo" SortExpression="Metodo"></asp:BoundField>
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT iDCliente, FechaVenta, Monto, Lineas, SubTotal, iDVenta, Row, Status, TipoVenta, Metodo, Direccion, Rif, Tipo FROM Cabecera WHERE (MONTH(FechaVenta) = @Mes) AND (YEAR(FechaVenta) = YEAR(GETDATE()))">
                    <SelectParameters>
            <asp:CookieParameter CookieName="mesR" Name="Mes" Type="String" />           
        </SelectParameters>
                    </asp:SqlDataSource>
                    </div>
            </div>
