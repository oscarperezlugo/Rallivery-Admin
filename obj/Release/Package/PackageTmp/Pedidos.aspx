...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">                        
                        <asp:Label ID="Label6" runat="server" Text="TOTAL PEDIDOS"  CssClass="titulocard"></asp:Label>                                                
                    </div>                   
                </div>
            </div>
        <div class="card-body">
...
<PagerStyle CssClass="pgr"></PagerStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PaladarMobileConnectionString %>" SelectCommand="SELECT [iDCliente], [FechaVenta], [Monto], [Lineas], [SubTotal], [iDVenta], [Row], [Status], [TipoVenta], [Metodo], [Direccion] FROM [Cabecera] WHERE (([Tipo] = @Tipo) OR ([Tipo] = @Tipo2))">
                        <SelectParameters>
