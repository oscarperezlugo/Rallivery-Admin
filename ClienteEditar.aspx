<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ClienteEditar.aspx.cs" Inherits="PanelAdmin.ClienteEditar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        <div class="card-header">
                <div class="form-row">
                    <div class="col10L">
                         <asp:Label ID="Label6" runat="server" Text="Registro de Cliente"  CssClass="titulocard"></asp:Label>
                    </div>
                </div>
            </div>
        <div class="card-body">            
            ...
            <table style="width: 100%;">
                ...
                <input class="formulario" placeholder="Dirección (Valencia, Prebo Calle Libra #55)" id="Dirección" type="text" required runat="server"/>            
                    ...
                    <td><div class="fila col10L">
                        <asp:Label ID="Label7" runat="server" Text="SICM" class="formularioTIT"></asp:Label><br />   
            ...
            <div class="fila col10L">
                <asp:Button runat="server" CssClass="botonsubmit"  OnClick="Unnamed1_Click"  Text="ACTUALIZAR CLIENTE"/>            
            </div>
        </div>
             </div>
        </div>
